...
import static characters.Entity.WEAPON;
...
public class Enemy extends Entity {
	...
	public static Enemy getGiantMouse() {
		Enemy giantMouse = new Enemy("Giant Mouse", 30, 0, 10, 6, 1, 20, 1, true); // Make Enemy
	...
	public static Enemy getGiantRoach() {
		Enemy giantRoach = new Enemy("Giant Roach", 20, 0, 5, 6, 1, 20, 1, true); // Make Enemy
		Weapon bite = new Weapon("bite", 0, 0, 0, 3, 4, 0, false); // Make Weapon for Enemy
	...
	public static Enemy getSkeleton() {
		Enemy skeleton = new Enemy("Skeleton", 50, 10, 20, 4, 3, 40, 1, true);
		skeleton.setEquippedItems(WEAPON, Weapon.ruggedSword);
		return skeleton;
	}
	
	public static Enemy getGiantSpider() {
		Enemy spider = new Enemy("Giant Spider", 40, 40, 30, 10, 5, 40, 1, true);
		spider.setEquippedItems(WEAPON, Weapon.ruggedSword);
		return spider;
	}
}
