...
import item.Weapon;
import static display.WordProcessing.randomColorfy;
...
public class Enemy extends Entity {
	...
	public static Enemy getGiantMouse() {
		Enemy giantMouse = new Enemy(randomColorfy("Giant Mouse"), 30, 0, 10, 6, 1, 20, 1, true); // Make Enemy
	...
	public static Enemy getGiantRoach() {
		Enemy giantRoach = new Enemy(randomColorfy("Giant Roach"), 20, 0, 5, 6, 1, 20, 1, true); // Make Enemy
		Weapon bite = new Weapon("bite", 0, 0, 0, 3, 0, false); // Make Weapon for Enemy
	...
	public static Enemy getSkeleton() {
		Enemy skeleton = new Enemy(randomColorfy("Skeleton"), 50, 10, 20, 4, 3, 40, 1, true);
		skeleton.setEquippedItems(Weapon.ruggedSword);
		return skeleton;
	}
	
	public static Enemy getGiantSpider() {
		Enemy spider = new Enemy(randomColorfy("Giant Spider"), 40, 40, 30, 10, 5, 40, 1, true);
